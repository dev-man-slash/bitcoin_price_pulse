...
class Bitcoin {
  ...
  Bitcoin.fromJson(Map<String, dynamic> json) {
    time = json['time'] != null ? UpdateTime.fromJson(json['time']) : null;
...
class UpdateTime {
  ...
  UpdateTime({this.updated, this.updatedISO, this.updateduk});

  UpdateTime.fromJson(Map<String, dynamic> json) {
